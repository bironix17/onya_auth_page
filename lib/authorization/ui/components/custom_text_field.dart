...
class CustomTextField extends StatefulWidget {
  ...
  CustomTextField({this.hintText, this.callbackOnChanged, this.text = "", this.errorText = null, this.isPasswordField = false});
      ...
      children: [
          ...
          child: TextField(
            ...
            decoration: InputDecoration(
              ...
              suffixIcon: widget.isPasswordField ?
                        IconButton(
                           icon: Icon(isShowPassword ? Icons.visibility : Icons.visibility_off, color: AppColors.primary),
                            onPressed: (){setState(() {
        ...
        if (widget.errorText != null && widget.errorText != "")
          Positioned(
            ...
            child: Row(
              children: [
                Icon(Icons.info, color: AppColors.primary, size: 15,),
                SizedBox(width: 4),
                Text(widget.errorText,
                    style: AppFonts.sfUiDisplayBold.copyWith( color: AppColors.primary, fontSize: 12),
